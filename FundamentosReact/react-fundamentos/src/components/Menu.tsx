import { Icon360View, IconArrowDownSquare, IconArrowsUpDown, IconArrowUpSquare, IconBraces, IconBrandJavascript, IconCalculatorFilled, IconCode, IconFunction, IconH1, IconHome, IconLayoutDashboardFilled, IconLayoutNavbarFilled, IconMoodSmileBeam, IconTournament } from "@tabler/icons-react";
...
export default function Menu() {
    return (
        ...
        ">
            <span className="flex items-center gap-2 text-sm text-zinc-500 pl-3 pt-4">Comunicação</span>
